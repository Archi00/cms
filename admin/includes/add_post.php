...
if(isset($_POST['create_post'])) {
  ...
  $query .= "VALUES ({$post_category_id}, '{$post_title}', '{$post_author}', now(), '{$post_image}', '{$post_comment}', '{$post_tags}', {$post_comment_count}, '{$post_status}' ) ";
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label for="post_content"> Post Content </label>
      <input class="form-control" name="post_comment" id="" cols="30" rows="10">
  </div>
